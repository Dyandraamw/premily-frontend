...
export default function invInstallmentForm() {
  const [insData, setInsData] = useState([{ due_date: dayjs().format('DD/MM/YYYY'), amount: "" }]);

  const handleClick = () => {
    setInsData([...insData, { due_date: dayjs().format('DD/MM/YYYY'), amount: "" }]);
  };
